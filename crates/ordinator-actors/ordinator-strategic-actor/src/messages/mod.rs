...
//
// The StrategicActors does not care which assets it is from, it
// should simply respond with a `message`. I do not see what other
// approach that we could take here.
#[derive(Deserialize, Serialize, Debug, Clone)]
